      ...
      <nav className="max-w-7xl mx-auto px-4 py-2">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex flex-1 max-w-2xl mx-8">
            <div className="relative w-full">
              <input
                ...
                className="w-full px-4 py-2 pl-10 pr-4 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent"
              />
          ...
          <div className="flex items-center space-x-4">
            ...
            {/* Wishlist */}
            <a href="/wishlist" className="hidden sm:block text-gray-700 hover:text-blue-600 transition-colors">
              <Heart className="h-6 w-6" />
            </a>

            {/* Account */}
            <a href="/account" className="hidden sm:block text-gray-700 hover:text-blue-600 transition-colors">
