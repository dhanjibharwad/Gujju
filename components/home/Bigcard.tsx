...
const CARDS: readonly Card[] = [
  { id: 1, title: 'MENS FASHION', image: 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=1200&q=80', rotation: '-rotate-6' },
  { id: 2, title: 'WOMENS FASHION', image: 'https://images.unsplash.com/photo-1445205170230-053b83016050?w=1200&q=80', rotation: 'rotate-0' },
  { id: 3, title: 'LAPTOPS', image: 'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=1200&q=80', rotation: 'rotate-6' },
  { id: 4, title: 'CAMERAS', image: 'https://images.unsplash.com/photo-1502920917128-1aa500764cbd?w=1200&q=80', rotation: '-rotate-5' },
  { id: 5, title: 'SMARTPHONES', image: 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=1200&q=80', rotation: 'rotate-5' }
] as const;
...
const CardItem = memo(({ card, index, isFirst }: { card: Card; index: number; isFirst: boolean }) => (
  ...
  >
    ...
    */}
    <div
      className={`relative w-[280px] md:w-[320px] h-[380px] md:h-[450px] ${card.rotation} transition-all duration-500 group-hover:rotate-0 rounded-lg overflow-hidden`}
    >
      <img
        src={card.image}
        alt={card.title}
